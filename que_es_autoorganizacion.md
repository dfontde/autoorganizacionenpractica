...
* 
* En una gran organización de salud, la PMO requeria planificación usando un diagrama de Gantt con responsales asignados a cada tarea, y las tareas predefinidas (análisis, diseño, construcción, prueba). La líder del proyecto negoció un acuerdo con la PMO para que la planificación se representaba con 
